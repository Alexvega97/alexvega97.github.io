...
map.getView().fit([-954801.084890, 4877853.873149, -286895.522547, 5316882.139985], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Ejercicio sobre el complemento qgis2web</h2>';
        return titleElement;
    })(),
